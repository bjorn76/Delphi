...
uses
  ...
  LMDButtonBase, LMDFormStyler, LMDContainerComponent, LMDBaseDialog, LMDDirDlg,
  ...
  LMDCustom3DButton, LMD3DEffectButton, LMDBitmapList, LMDBaseController,
  LMDCustomContainer, LMDCustomImageList, LMDImageList,
  LMDWndProcComponent, ExtCtrls;
