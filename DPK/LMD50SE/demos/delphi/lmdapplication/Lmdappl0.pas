...
uses
  ...
  Forms, Dialogs, lmdctrl, lmdbtn, StdCtrls, lmdstdcS, ExtCtrls,
  lmdclass, lmdcont, lmdextcA, Menus, lmdextcS, lmdgraph, lmddlgS,
  lmdmmS, lmdprocs, lmdnonvS, lmdformA, lmdcompo, LMDApplicationCtrl,
  LMDWndProcComponent, LMDFormStyler, LMDCustomComponent, LMDWaveComp,
  LMDCustomButton, LMDButton, LMDDrawEdge, LMDControl, LMDBaseControl,
