...
uses
  ...
  Forms, Dialogs, lmdclass, lmdformA, ExtCtrls, StdCtrls, lmdstdcA,
  lmdstdcS, lmdctrl, lmdcont, lmdbtn, lmdnonvS, lmdctrlA,
  ComCtrls, Spin, lmdextcS, lmdcompo, lmdcombo, LMDApplicationCtrl,
