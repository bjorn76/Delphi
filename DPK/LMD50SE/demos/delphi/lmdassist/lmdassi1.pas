...
uses
  ...
  StdCtrls, lmdstdcS, lmdctrl, lmdctrlA, lmdextcA, lmddlgS, lmdclass,
  lmdcont, lmdextcS, lmdformA, lmdcompo, lmdcctrl, LMDWndProcComponent,
  ...
  LMDSimpleLabel, LMDCustomControl, LMDAssist;
