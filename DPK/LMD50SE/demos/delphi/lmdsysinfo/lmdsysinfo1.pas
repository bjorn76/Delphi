...
uses
  ...
  ComCtrls, lmdclass, lmdnonvS, StdCtrls, lmdctrl, lmdextcA, lmdstdcS,
  lmdextcS, ExtCtrls, Menus, lmdgroup, lmdstdcA, lmddlgS, ExtDlgs,
  lmdbtn, registry, lmdformA, lmdcompo, lmdcctrl, LMDWndProcComponent,
  ...
  LMDSimpleLabel, LMDControl, LMDDrawEdge, LMDSysInfo;
